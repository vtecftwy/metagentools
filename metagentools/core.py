...
# %% auto 0
__all__ = ['CODE_ROOT', 'PACKAGE_ROOT', 'ProjectFileSystem', 'SqliteDatabase', 'JsonDict', 'JsonFileReader', 'TextFileBaseReader',
...
class SqliteDatabase:
    ...
    def dataframe_to_table(
        ...
        index:bool=False         # Write the DataFrame index as a column
        ):
