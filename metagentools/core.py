...
# %% auto 0
__all__ = ['TextFileBaseReader', 'JsonFileReader', 'ProjectFileSystem', 'TextFileBaseIterator']
...
class TextFileBaseReader:
    ...
    def __init__(
        ...
        self.parsing_rules_json = Path('../default_parsing_rules.json')
...
class ProjectFileSystem:
    """Callable singleton class to set key paths according to whether the code is running locally or in the cloud
    
    Assumes the following project file system:
        ...
        - if running on google colab:
            ...
            - gdrive root includes a shortcut named `Metagenomics` to the following project shared directory `/https://drive.google.com/drive/folders/134uei5fmt08TpzhmjG4sW0FQ06kn2ZfZ`
    """
    ...
    def __new__(
        cls, 
        mount_gdrive:bool=True    # Set to False if do not want to mount gdrive opn Colab
        ):
        ...
        if cls._instance is None:
            ...
            cls.is_colab = 'google.colab' in sys.modules       
            if cls.is_colab and mount_gdrive:
                drive.mount('/content/gdrive')
                cls.gdrive = Path('/content/gdrive/MyDrive')

            cls.is_kaggle = 'kaggle_web_client' in sys.modules
            if cls.is_kaggle:
                raise ValueError(f"ProjectFileSystem is not configured to run on Kaggle yet")
